...
{
  os << indent << "Molecule: " << this->molecule_ << " Id: " << this->Id_
...
{
  return this->molecule_->GetAtomAtomicNumber(this->Id_);
}

//------------------------------------------------------------------------------
void Atom::SetAtomicNumber(unsigned short atomicNum, short subtype)
{
  this->molecule_->SetAtomAtomicNumber(this->Id_, atomicNum);
}

//------------------------------------------------------------------------------
void Atom::GetPosition(float pos[3]) const
{
  this->molecule_->GetAtomPosition(this->Id_, pos);
}
...
{
  this->molecule_->SetAtomPosition(this->Id_, vtkVector3f(pos));
}

//------------------------------------------------------------------------------
void Atom::SetPosition(float x, float y, float z)
{
  this->molecule_->SetAtomPosition(this->Id_, x, y, z);
}

//------------------------------------------------------------------------------
vtkVector3f Atom::GetPosition() const
{
  return this->molecule_->GetAtomPosition(this->Id_);
}

//------------------------------------------------------------------------------
void Atom::SetPosition(const vtkVector3f& pos)
{
  this->molecule_->SetAtomPosition(this->Id_, pos);
}
