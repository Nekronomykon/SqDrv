...
//------------------------------------------------------------------------------
AcquireFileWFX::AcquireFileWFX() : AcquireMoleculeFile(0, 1) {}
...
//------------------------------------------------------------------------------
int AcquireFileWFX::RequestData(vtkInformation *vtkNotUsed(request),
                                ...
                                vtkInformationVector *outputVector)
{
    ...
    if (!output)
    {
        vtkErrorMacro("AcquireFileWFX does not have a Molecule as output.");
        return 1;
    }
    ...
    {
        vtkErrorMacro("AcquireFileWFX error opening file: " << this->GetFileName());
        return 0;
    }
    ...
    if (!fileInput)
    {
        vtkErrorMacro("AcquireFileWFX signaled an unexpected EOF in file: " << this->GetFileName());
        return 0;
    }
    ...
    for (int i = 0; i < nAtoms; i++)
    {
        ...
        {
            vtkErrorMacro("AcquireFileWFX error reading file: "
