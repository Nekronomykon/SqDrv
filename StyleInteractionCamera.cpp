...
vtkStandardNewMacro(StyleInteractionCamera);
...
//------------------------------------------------------------------------------
StyleInteractionCamera::~StyleInteractionCamera() = default;

//------------------------------------------------------------------------------
void StyleInteractionCamera::OnMouseMove()
{
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnLeftButtonDown()
{
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnLeftButtonUp()
{
  switch (this->State)
  {
  case VTKIS_DOLLY:
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnMiddleButtonDown()
{
  this->FindPokedRenderer(
      this->Interactor->GetEventPosition()[0], this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == nullptr)
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnMiddleButtonUp()
{
  switch (this->State)
  {
  case VTKIS_PAN:
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnRightButtonDown()
{
  this->FindPokedRenderer(
      this->Interactor->GetEventPosition()[0], this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == nullptr)
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnRightButtonUp()
{
  switch (this->State)
  {
  case VTKIS_ENV_ROTATE:
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnMouseWheelForward()
{
  this->FindPokedRenderer(
      this->Interactor->GetEventPosition()[0], this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == nullptr)
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::OnMouseWheelBackward()
{
  this->FindPokedRenderer(
      this->Interactor->GetEventPosition()[0], this->Interactor->GetEventPosition()[1]);
  if (this->CurrentRenderer == nullptr)
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::Rotate()
{
  if (this->CurrentRenderer == nullptr)
  {
    return;
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::Spin()
{
  if (this->CurrentRenderer == nullptr)
  {
    return;
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::Pan()
{
  if (this->CurrentRenderer == nullptr)
  {
    return;
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::Dolly()
{
  if (this->CurrentRenderer == nullptr)
  {
    return;
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::Dolly(double factor)
{
  if (this->CurrentRenderer == nullptr)
  {
    return;
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::EnvironmentRotate()
{
  if (this->CurrentRenderer == nullptr)
  {
    return;
...
//------------------------------------------------------------------------------
void StyleInteractionCamera::PrintSelf(ostream &os, vtkIndent indent)
{
