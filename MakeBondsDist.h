...
=========================================================================*/
/**
 * @class   MakeBondsDistances
 * @brief   Create a simple guess of a Molecule's bondset topology
 *
 *
 *
 * MakeBondsDistances performs a simple check of all interatomic distances
...
class vtkDataSet;
class vtkPeriodicTable; // --> vtk::Elements
...
class /* VTKDOMAINSCHEMISTRY_EXPORT*/ MakeBondsDistances 
: public MoleculeBuild
{
public:
  static MakeBondsDistances* New();
  vtkTypeMacro(MakeBondsDistances, MoleculeBuild);
...
protected:
  explicit MakeBondsDistances();
  ~MakeBondsDistances() override;
   ...
   */
  virtual void ComputeBonds(Molecule* /*molecule*/);
...
private:
  MakeBondsDistances(const MakeBondsDistances&) = delete;
  void operator=(const MakeBondsDistances&) = delete;
}; // MakeBondsDistances

}; // namespace vtk

#endif // !vtkSimpleBondPerceiver_h
